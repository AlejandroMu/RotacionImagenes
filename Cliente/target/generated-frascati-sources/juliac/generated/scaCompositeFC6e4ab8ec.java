...
public class scaCompositeFC6e4ab8ec
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("multiplicar","java.lang.Runnable",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("rotar","java.lang.Runnable",false,false,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    proxy = new juliac.generated.java.lang.RunnableFcInItf(proxyForCompCtrl,"multiplicar",new org.objectweb.fractal.julia.type.BasicInterfaceType("multiplicar","java.lang.Runnable",false,false,false),false,intercept);
    ic.interfaces.put("multiplicar",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    proxy = new juliac.generated.java.lang.RunnableFcOutItf(proxyForCompCtrl,"multiplicar",new org.objectweb.fractal.julia.type.BasicInterfaceType("multiplicar","java.lang.Runnable",true,false,false),true,intercept);
    ic.internalInterfaces.put("multiplicar",proxy);
    intercept = new juliac.generated.java.lang.RunnableInterceptorSCAIntent();
    ic.controllers.add(intercept);
    ((org.objectweb.fractal.julia.Interceptor)intercept).setFcItfDelegate(content);
    proxy = new juliac.generated.java.lang.RunnableFcInItf(proxyForCompCtrl,"rotar",new org.objectweb.fractal.julia.type.BasicInterfaceType("rotar","java.lang.Runnable",false,false,false),false,intercept);
    ic.interfaces.put("rotar",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    proxy = new juliac.generated.java.lang.RunnableFcOutItf(proxyForCompCtrl,"rotar",new org.objectweb.fractal.julia.type.BasicInterfaceType("rotar","java.lang.Runnable",true,false,false),true,intercept);
    ic.internalInterfaces.put("rotar",proxy);
    initFcController(ic);
