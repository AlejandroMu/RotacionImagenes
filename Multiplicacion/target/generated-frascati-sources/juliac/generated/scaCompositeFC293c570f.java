...
public class scaCompositeFC293c570f
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("multiplicar","edu.icesi.interfaces.IMatrixOperations",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("attach","java.lang.Runnable",false,false,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    proxy = new edu.icesi.interfaces.IMatrixOperationsFcOutItf(proxyForCompCtrl,"multiplicar",new org.objectweb.fractal.julia.type.BasicInterfaceType("multiplicar","edu.icesi.interfaces.IMatrixOperations",true,false,false),true,intercept);
    ic.internalInterfaces.put("multiplicar",proxy);
    ...
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    proxy = new juliac.generated.java.lang.RunnableFcOutItf(proxyForCompCtrl,"attach",new org.objectweb.fractal.julia.type.BasicInterfaceType("attach","java.lang.Runnable",true,false,false),true,intercept);
    ic.internalInterfaces.put("attach",proxy);
    initFcController(ic);
