...
public class MultiplicateMatrixFCscaPrimitiveFC4823fccc
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("multiplicar","edu.icesi.interfaces.IMatrixOperations",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("attach","java.lang.Runnable",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("broker","edu.icesi.interfaces.IBroker",true,true,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("mVectors","edu.icesi.interfaces.IMultiplicationVectors",true,true,false),} );
    }
  ...
  public Object getFcContentDesc()  {
      return "edu.icesi.MultiplicacionMatrices.MultiplicateMatrix";
  }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.content = edu.icesi.MultiplicacionMatrices.MultiplicateMatrix.class;
    ...
    ic.controllers.add(intercept);
    ((org.objectweb.fractal.julia.Interceptor)intercept).setFcItfDelegate(content);
    proxy = new juliac.generated.java.lang.RunnableFcInItf(proxyForCompCtrl,"attach",new org.objectweb.fractal.julia.type.BasicInterfaceType("attach","java.lang.Runnable",false,false,false),false,intercept);
    ic.interfaces.put("attach",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    intercept = new edu.icesi.interfaces.IBrokerInterceptorSCAIntent();
    ic.controllers.add(intercept);
    proxy = new edu.icesi.interfaces.IBrokerFcOutItf(proxyForCompCtrl,"broker",new org.objectweb.fractal.julia.type.BasicInterfaceType("broker","edu.icesi.interfaces.IBroker",true,true,false),false,intercept);
    ic.interfaces.put("broker",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    intercept = new edu.icesi.interfaces.IMultiplicationVectorsInterceptorSCAIntent();
    ic.controllers.add(intercept);
    proxy = new edu.icesi.interfaces.IMultiplicationVectorsFcOutItf(proxyForCompCtrl,"mVectors",new org.objectweb.fractal.julia.type.BasicInterfaceType("mVectors","edu.icesi.interfaces.IMultiplicationVectors",true,true,false),false,intercept);
    ic.interfaces.put("mVectors",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    initFcController(ic);
  ...
  public org.objectweb.fractal.api.Component newFcControllerInstantiation(org.objectweb.fractal.julia.InitializationContext ic) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.controllers.add(ctrl = new edu.icesi.MultiplicacionMatrices.MultiplicateMatrixFCSCAContentControllerImpl());
